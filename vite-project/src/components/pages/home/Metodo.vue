<template>
    ...
    <div class="flex flex-col justify-center gap-5">
        <section class="flex w-full px-5 py-5 flex-col items-start gap-5 bg-[#6113c6] text-white">
            <h2 class="text-center text-[clamp(22px,5vmin,30px)] font-semibold">Sobre o Software</h2>
        ...
        <section class="flex px-5 flex-col items-start self-stretch bg-white text-black">
            <h2 class="text-center text-[clamp(22px,5vmin,30px)] font-semibold">Sexto Nervo Óptico</h2>
            <div class="flex flex-row pt-[13px] items-start justify-start gap-[81px] w-full max-[700px]:flex-col">
                <p class="flex-[0.9]" id="optic-nerve-description">
                ...
                <div class="flex items-center p-[1px] border border-[#61616198] pb-5 max-[700px]:w-full max-[700px]:justify-center">
                    <img
                        alt="Ilustração do sexto nervo óptico"
                        class="w-auto h-[clamp(24vmin,236px,50vmin)] aspect-[379/336] max-[700px]:w-[clamp(20vmin,286px,376px)] max-[700px]:h-auto"
        ...
        <section class="flex w-full px-5 py-5 flex-col items-start gap-5 bg-[#6113c6] text-white">
            <h2 class="text-center text-[clamp(22px,5vmin,30px)] font-semibold" id="titulo-protocolo">Protocolo de Aquisição</h2>
        ...
        <section class="flex w-full px-5 py-5 flex-col items-start gap-5 bg-white text-black">
            <h2 class="text-center text-[clamp(22px,5vmin,30px)] font-semibold" id="titulo-deteccao">Método de Detecção</h2>
        ...
        <section class="flex w-full px-5 py-5 flex-col items-start gap-5 bg-[#6113c6] text-white">
            <h2 class="text-center text-[clamp(22px,5vmin,30px)] font-semibold" id="metodo">Método de Cálculo da Velocidade</h2>
