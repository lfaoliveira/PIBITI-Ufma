<template>
    ...
    <h1 class="text-[#3a0d75] text-[clamp(39px,2.5em,4vmin)] mt-[clamp(30px,6vmin,120px)] mx-auto">Etapa {{ this.cont }} de 3: {{ this.tituloAtual }}</h1>
    <OverlayAviso
        class="my-[2vmin] self-center bg-white"
    ...
    />
    <main class="h-[80vmin]">
        <figure class="transition-[duration-4ms] bg-black w-auto h-full flex items-center justify-center">
            <section class="text-white w-[clamp(110px,30vmin,400px)] h-auto">
                <div>
                    <!-- <div
                ...
                <div class="text-center mt-2">{{ parseInt(this.percent) }}% Completo</div>
            </section>
        </figure>
    </main>
